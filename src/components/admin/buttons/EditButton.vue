<template>
  <button
    type="button"
    :id="`#${id}`"
    class="m-1 inline-flex items-center gap-x-2 px-4 py-3 text-sm font-medium rounded-lg border border-transparent bg-yellow-500 text-white hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 disabled:opacity-50 disabled:pointer-events-none"
